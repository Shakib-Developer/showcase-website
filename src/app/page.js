...
export default function Home() {
  return (
    <main>
        ...
        <div className="container mx-auto">
          <div className="grid grid-cols-12  justify-between items-center gap-[30px]">
            <div className="lg:col-span-6 col-span-12">
              <h2 className="lg:text-5xl text-4xl font-semibold mb-7">
                The best way to
      ...
      <section className="py-20">
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-12 items-center gap-6 mt-[100px]">
            <div className="lg:col-span-5 col-span-12 mb-4 lg:mb-0">
              <img
                src="/assets/app2.png"
                className="  mx-auto"
            ...
            <div className="lg:col-span-7 col-span-12">
              <div className="grid md:grid-cols-2 grid-cols-1 gap-8 lg:ps-32 text-center lg:text-left">
                <div>
                  <span className="flex items-center justify-center rounded-md w-12 mx-auto lg:mx-0 h-12 bg-blue-100">
                    <svg
                ...
                <div>
                  <span className="flex items-center justify-center rounded-md w-12 mx-auto lg:mx-0 h-12 bg-green-100">
                    <svg
                ...
                <div>
                  <span className="flex items-center justify-center rounded-md w-12 mx-auto lg:mx-0 h-12 bg-orange-50">
                    <svg
                ...
                <div>
                  <span className="flex items-center justify-center rounded-md w-12 mx-auto lg:mx-0 h-12 bg-teal-100">
                    <svg
      ...
      {/* Powerfull Features Section Close */}
